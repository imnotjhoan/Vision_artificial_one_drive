...
if __name__ == "__main__":
    ...
    imageBinary = my_functions.binaryImageGray(imageGray,155,cv2.THRESH_BINARY) # Convertir imagen de gris a binario
...
# recorrer la imagen binaria por columnas y filas    
    ...
    # search the biggest difference in horizontal and vertical vectors substracting consecutive elements

    
    # take last value of vertical and horizontal vectors
